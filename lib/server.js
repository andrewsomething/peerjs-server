...
function PeerServer(options) {
  ...
  this._options = util.extend({
    ...
    before_connect: function (req, res, next){ return next(); }
  }, options);
  ...
  this._initializeHTTP(this._options.before_connect);
...
PeerServer.prototype._initializeHTTP = function(Middleware) {
  var self = this;
